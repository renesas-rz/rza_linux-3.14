...
static struct pfc_pinmux_assign lcd0_common[] = {
	...
	{ P5_0,   ALT3, },	/* LCD0_DATA16 */
	{ P5_1,   ALT3, },	/* LCD0_DATA17 */
	{ P5_2,   ALT3, },	/* LCD0_DATA18 */
	{ P5_3,   ALT3, },	/* LCD0_DATA19 */
	{ P5_4,   ALT3, },	/* LCD0_DATA20 */
	{ P5_5,   ALT3, },	/* LCD0_DATA21 */
	{ P5_6,   ALT3, },	/* LCD0_DATA22 */
	{ P5_7,   ALT3, },	/* LCD0_DATA23 */
};
...
/* BOARD: Define your [LCD0] frame buffer location and size. */
  ...
  #define VDC5_0_FBSIZE (1280*800*VDC5_0_BPP/8)
...
static struct fb_videomode videomode_hsd070pww1 = {
	...
	.hsync_len	= 160,	/* Horizontal Blanking Time */
	.vsync_len	= 23,	/* Vertical Blanking Time */
...
static const struct vdc5fb_pdata vdc5fb_hsd070pww1_pdata = {
	...
	.tcon_sel		= {
		...
		[LCD_TCON4]	= TCON_SEL_STH,		/* HSYNC */
		[LCD_TCON5]	= TCON_SEL_STVA,	/* VSYNC */
		[LCD_TCON6]	= TCON_SEL_DE,		/* DEN */
	},
...
/* BOARD: This is the Capacitive touchscreen controller that
	  is on the RSK board */
static struct pixcir_ts_platform_data pixcir_pdata __initdata = {
	.x_max = 1280,
	.y_max = 800,
};
...
//	{34, 1},	/* IRQ2 */
//	{35, 1},	/* IRQ3 */
	{36, 1},	/* IRQ4 (for pixcir-ts Touchscreen) */
//	{37, 1},	/* IRQ5 */
//	{38, 1},	/* IRQ6 */
//	{39, 1},	/* IRQ7 */
...
static void __init ylcdrza1h_add_standard_devices(void)
{
	...
	r7s72100_pfc_pin_assign(P11_12, ALT4, DIIO_PBDC_DIS);	/* MMC DAT4 */
	r7s72100_pfc_pin_assign(P11_13, ALT4, DIIO_PBDC_DIS);	/* MMC DAT5 */
	r7s72100_pfc_pin_assign(P11_14, ALT4, DIIO_PBDC_DIS);	/* MMC DAT6*/
	r7s72100_pfc_pin_assign(P11_15, ALT4, DIIO_PBDC_DIS);	/* MMC DAT7 */

	r7s72100_pfc_pin_assign(P4_8, ALT3, DIIO_PBDC_DIS);	/* SDHI0 CD */
	r7s72100_pfc_pin_assign(P4_9, ALT3, DIIO_PBDC_DIS);	/* SDHI0 WP */
	r7s72100_pfc_pin_assign(P4_10, ALT3, DIIO_PBDC_EN);	/* SDHI0 DAT1 */
	r7s72100_pfc_pin_assign(P4_11, ALT3, DIIO_PBDC_EN);	/* SDHI0 DAT0 */
	r7s72100_pfc_pin_assign(P4_12, ALT3, DIIO_PBDC_DIS);	/* SDHI0 CLK */
	r7s72100_pfc_pin_assign(P4_13, ALT3, DIIO_PBDC_EN);	/* SDHI0 CMD */
	r7s72100_pfc_pin_assign(P4_14, ALT3, DIIO_PBDC_EN);	/* SDHI0 DAT3*/
	r7s72100_pfc_pin_assign(P4_15, ALT3, DIIO_PBDC_EN);	/* SDHI0 DAT2 */
	...
	{
		/* Manually set IRQ4 for 'falling edge' trigger in Interrupt Control Register 1 */
		void __iomem *irc1 = IOMEM(0xfcfef802);
		__raw_writew((__raw_readw(irc1) & ~(0x2 << 8)), irc1);
		r7s72100_pfc_pin_assign(P1_10, ALT3, DIIO_PBDC_DIS);  /* IRQ4 */
	}
...
static void __init ylcdrza1h_init_late(void)
{
	static u8 *jpeg_buf;
	jpeg_buf = kmalloc(1024*1024, 0);
	printk("jpeg: buffer @ %p\n", (void *)virt_to_phys(jpeg_buf));
...
static const char * const ylcdrza1h_boards_compat_dt[] __initconst = {
	"renesas,ylcdrza1h",
	NULL,
};

DT_MACHINE_START(YLCDRZA1H_DT, "ylcdrza1h")
	.init_early	= r7s72100_init_early,
	.init_machine	= ylcdrza1h_add_standard_devices,
	.init_late	= ylcdrza1h_init_late,
	.dt_compat	= ylcdrza1h_boards_compat_dt,
