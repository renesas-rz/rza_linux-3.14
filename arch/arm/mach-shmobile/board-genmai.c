...
/* SDHI0 vs. SCIF1, heartbeat
 * - Enabling SDHI0 will enable the SD card slot.  (The MMC/SD slot is on SDHI1.)
 * - SCIF1 and heartbeat cannot be enabled when SDHI0 is active.
 */
#define SDHI0_ENABLE
//#define SCIF1_ENABLE
...
*/
static struct fb_videomode videomode_adv7123 = {
	.name		= "adv7123",
	.refresh	= 60,
	.xres		= 800,
	.yres		= 600,
	.pixclock	= PIXCLOCK(P1CLK, 2),
	.left_margin	= 80,	/* horizontal back porch */
	.right_margin	= 40,	/* horizontal front porch */
	.upper_margin	= 23,	/* vertical back porch */
	.lower_margin	= 34,	/* vertical front porch */
	.hsync_len	= 128,	/* max */
	.vsync_len	= 23,	/* max */
	.sync		= 0,
	.vmode		= 0,
...
static const struct vdc5fb_pdata vdc5fb_adv7123_pdata = {
	.name			= "adv7123",
	.videomode		= &videomode_adv7123,
...
static const struct platform_device_info vdc5fb0_info __initconst = {
	...
	.data		= &vdc5fb_adv7123_pdata,
	.size_data	= sizeof(vdc5fb_adv7123_pdata),
...
#ifdef SCIF1_ENABLE
	r7s72100_register_scif(1);	/* SCIF ch1 */
#endif
...
static void __init genmai_init_late(void)
{
