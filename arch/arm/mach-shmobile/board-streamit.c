...
static const struct rza1_dma_pdata dma_pdata __initconst = {
	...
	.channel_num	= 2,	/* Less channels means less RAM (2 for SDHI, 4 for Audio) */
#else
...
#ifdef SPI_TESTING
static struct spi_board_info streamit_spi_devices[] __initdata = {
...
R7S72100_SCIF(3, 0xe8008800, gic_iid(233));	/* console */
...
// SHARP had these commented out for some reason
...
static const struct platform_device_info alsa_soc_info = {
	.name		= "streamit_alsa_soc_platform",
	.id		= 0,
};
...
#endif /* CONFIG_VIDEO_SH_MOBILE_CEU */
...
static void __init streamit_add_standard_devices(void)
{
...
#ifdef SPI_TESTING
	spi_register_board_info(streamit_spi_devices,
				ARRAY_SIZE(streamit_spi_devices));
#endif

//	r7s72100_register_scif(0);	/* SCIF ch0 */ /* Not used */
//	r7s72100_register_scif(1);	/* SCIF ch1 */ /* Not used */
//	r7s72100_register_scif(2);	/* SCIF ch2 */ /* Not used */
	r7s72100_register_scif(3);	/* SCIF ch3 */ /* Console */
...
static void __init streamit_init_late(void)
{
...
static const char * const streamit_boards_compat_dt[] __initconst = {
	"renesas,streamit",
	NULL,
};

DT_MACHINE_START(RSKRZA1_DT, "streamit")
	.init_early	= r7s72100_init_early,
	.init_machine	= streamit_add_standard_devices,
	.init_late	= streamit_init_late,
	.dt_compat	= streamit_boards_compat_dt,
